...
　より具体的に言うと，Castryck と Decru によって 2022 年の夏頃に SIDH（更に正確には SIKE）を破る論文が出されちょうどそれを読んでいたのですがあまりにも難しくて，それの実装を達成するために講師の方の力を借りようと思いました．というのもこのアルゴリズムは公開実装例が２つしか見当たらなかった（しかもどっちも実装を含めて論文になっている）くらいには難解で，ちょっと僕だけではしっかり論文を読めないなと思ったからです．
...
以降の設問文は全て応募課題からの引用です．(プロトコルコースや他ゼミの応募課題も含めた応募課題関連の情報は [ここ](https://www.ipa.go.jp/jinzai/security-camp/2023/zenkoku/vote.html) に色々書いてあります)
...
ゼミによっては簡潔にまとまっているものを評価するところもあるようなので，僕のこの記事が参考になるかはちょっと微妙です……．  
それに僕のこの解答はまだまだ甘い部分が多く僕自身知識が浅いので，もしこの記事を参考に課題を書こうとしている方がいればそれは**非推奨**です．僕の文章なんかよりもよく纏まった論文はたくさんありますし，講師の先生方は「原著にあたる」気持ちを重要視していたので，言葉通り原著にあたって真に理解してみてください．（暗号界隈はとてもオープンで，ePrint なんかで論文がサッと読めるのはありがたいですね）  
これは僕の個人的な意見なのですが，ライブラリやツールに頼るだけでなく中身がどうなっているかを数学としてしっかり理解していくのが暗号の勉強で重要だと感じています．（暗号に限らない話だと思いますが）  
またその過程でどんなに時間がかかろうと，最終的に理解して腑に落ちて飲み込めることが一番評価されるポイントだと思っています．他のゼミもそうだとは思いますが，少なくとも L1 ゼミはその部分を評価してくれるような場所だったのでありがたかったです．  
ということでもし今応募課題を解こうとして困っている方がいれば，とにかく基本問題だけでもゆっくりと考えて自分の力で思考してみて，暗号を飼うように日々頭の中で理解することを楽しんでみてください．それができれば僕のこの記事なんかよりも自分の理解のために勉強してきた記録が一番の参考文献になっているはずです．さらにそういう方はきっとセキュリティキャンプにも受かると思います．  

あとは多分熱意を伝えるのは大事です．講師の先生方を仰天させるような課題をぜひ投稿してみてください！！

つたない文章でしたが読んでいただきありがとうございました．それでは！
