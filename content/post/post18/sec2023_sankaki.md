...
date: 2023-08-13T10:03:49+09:00
draft: true
---
...
　L1 の応募課題は全体的に難しく，なかなか厳しい内容でした．ただ薄っすらと「完全解答を作る必要はなく，応募課題のためにどのようなことを学び調べたか」を重要視してるっように感じられたので，真の意味で正しい回答ではなくとにかく頑張るのが大事なのかなって思いました．（実際僕は Q2 の発展問題の解答がギャグみたいになっていて十分に正しく書けていない）  
...
　ちなみに L1 ゼミの実態なのですが，名前の通り暗号化通信をメインにやるゼミです．とはいってもプロトコルコースとプリミティブコースがあり，プロトコルコースでは例年（といってもコースが別れたのは今年からではありますが）TLS 自作をしているっぽいです（多分）．一方プリミティブコースは暗号の理論よりの内容をガリガリとやるところで，暗号の解読などを数学として頑張ってやるコースです．
...
　プロトコルコースの子や講師の方とも喋りながら，「キャンプで何を開発したいか」という目標を定めることをしました．  
...
　そう思いながら，とりあえずコードのリファクタリングをしていました．ここで講師の先生から最近とある CTF で出題された問題が僕の書いたコードで解けるか試してみないかと言われました．  
...
　この日の夜はその高速化を実装しようと思い頑張っていましたが，論文中に詳しくは書かれておらず内容がだいぶ省かれていました．なかなかうまくいかなくてとても困っていたまま４日目突入です．

## ４日目

　色々な値を試して検証しつつ高速化を実装まで落とし込もうと思いましたがどうもうまくいかず，少なくともキャンプ期間中では厳しそう（というのも３日目と４日目を過ぎたらあとは成果発表だから）だということになり，マルチスレッドに対応することで少しでも早くしようという風に切り替えました．
...
　まこさんに説明するのに一時間半かかっていたくらいなので当然 2 分で終わるわけもなく，本番の成果発表はタキオンでいこうと L トラックのプロデューサーさんには言われました．
